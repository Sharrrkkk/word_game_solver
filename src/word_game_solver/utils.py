...
All functions, classes and methods are subject to your proprietary
documentation.
"""
...
class Logs:
    ...
    the user's interaction, and at the end of the use of the application,
    we protect you from the history of the user, you decide on the entry 
    and sale of data, only you protect the affected actions.
    """
    @staticmethod
...
def about()-> None:
    ...
    The README.md file contains all the information about the development
    of this project, including the name of the creator, version, maintainer,
    project repositories, how to use it, examples, project structure,
